...
// database values
$phpwcms['db_host'] = '[[softdbhost]]';
$phpwcms['db_user'] = '[[softdbuser]]';
$phpwcms['db_pass'] = '[[softdbpass]]';
$phpwcms['db_table'] = '[[softdb]]';
$phpwcms['db_prepend'] = '[[dbprefix_]]';
$phpwcms['db_pers'] = 1;
$phpwcms['db_charset'] = 'utf8';
$phpwcms['db_collation'] = 'utf8_general_ci';
$phpwcms['db_version'] = '[[dbserversion]]';
...
$phpwcms['admin_name'] = '[[admin_realname]]'; //default: Webmaster
$phpwcms['admin_user'] = '[[admin_username]]'; //default: admin
$phpwcms['admin_pass'] = '[[admin_pass]]'; //MD5(phpwcms)
$phpwcms['admin_email'] = '[[admin_email]]'; //default: noreplay@host

// paths
$phpwcms['DOC_ROOT'] = $_SERVER['DOCUMENT_ROOT'];// current DOC_ROOT seems to be: '[[DOC_ROOT]]' 
$phpwcms['root'] = '[[relativeurl_]]'; //default: ''
