...
--
-- Table structure for table `[[dbprefix]]action_logs`
--

CREATE TABLE `[[dbprefix]]action_logs` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `message_language_key` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `message` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `log_date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `extension` varchar(50) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `user_id` int(11) NOT NULL DEFAULT '0',
  `item_id` int(11) NOT NULL DEFAULT '0',
  `ip_address` varchar(40) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '0.0.0.0',
  PRIMARY KEY (`id`),
  KEY `idx_user_id` (`user_id`),
  KEY `idx_user_id_logdate` (`user_id`,`log_date`),
  KEY `idx_user_id_extension` (`user_id`,`extension`),
  KEY `idx_extension_item_id` (`extension`,`item_id`)
) ENGINE=InnoDB DEFAULT CHARSET=[[utf8]] COLLATE=[[utf8]]_unicode_ci AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Table structure for table `[[dbprefix]]action_logs_extensions`
--

CREATE TABLE `[[dbprefix]]action_logs_extensions` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `extension` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=[[utf8]] COLLATE=[[utf8]]_unicode_ci AUTO_INCREMENT=19 ;

--
-- Dumping data for table `[[dbprefix]]action_logs_extensions`
--

INSERT INTO `[[dbprefix]]action_logs_extensions` VALUES
(1, 'com_banners'),
(2, 'com_cache'),
(3, 'com_categories'),
(4, 'com_config'),
...
--
-- Table structure for table `[[dbprefix]]action_logs_users`
--

CREATE TABLE `[[dbprefix]]action_logs_users` (
  `user_id` int(10) unsigned NOT NULL,
  `notify` tinyint(3) unsigned NOT NULL,
  `extensions` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  PRIMARY KEY (`user_id`),
  KEY `idx_notify` (`notify`)
) ENGINE=InnoDB DEFAULT CHARSET=[[utf8]] COLLATE=[[utf8]]_unicode_ci;

-- --------------------------------------------------------

--
-- Table structure for table `[[dbprefix]]action_log_config`
--

CREATE TABLE `[[dbprefix]]action_log_config` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `type_title` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `type_alias` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `id_holder` varchar(255) COLLATE [[utf8]]_unicode_ci DEFAULT NULL,
  `title_holder` varchar(255) COLLATE [[utf8]]_unicode_ci DEFAULT NULL,
  `table_name` varchar(255) COLLATE [[utf8]]_unicode_ci DEFAULT NULL,
  `text_prefix` varchar(255) COLLATE [[utf8]]_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=[[utf8]] COLLATE=[[utf8]]_unicode_ci AUTO_INCREMENT=20 ;

--
-- Dumping data for table `[[dbprefix]]action_log_config`
--

INSERT INTO `[[dbprefix]]action_log_config` VALUES
...
CREATE TABLE `[[dbprefix]]assets` (
  ...
  `name` varchar(50) COLLATE [[utf8]]_unicode_ci NOT NULL COMMENT 'The unique name for the asset.\n',
  `title` varchar(100) COLLATE [[utf8]]_unicode_ci NOT NULL COMMENT 'The descriptive title for the asset.',
  `rules` varchar(5120) COLLATE [[utf8]]_unicode_ci NOT NULL COMMENT 'JSON encoded access control.',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_asset_name` (`name`),
  KEY `idx_lft_rgt` (`lft`,`rgt`),
  KEY `idx_parent_id` (`parent_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=[[utf8]] COLLATE=[[utf8]]_unicode_ci AUTO_INCREMENT=60 ;
...
CREATE TABLE `[[dbprefix]]associations` (
  ...
  `context` varchar(50) COLLATE [[utf8]]_unicode_ci NOT NULL COMMENT 'The context of the associated item.',
  `key` char(32) COLLATE [[utf8]]_unicode_ci NOT NULL COMMENT 'The key for the association computed from an md5 on associated ids.',
...
CREATE TABLE `[[dbprefix]]banners` (
  ...
  `name` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET [[utf8]] COLLATE [[utf8]]_bin NOT NULL DEFAULT '',
  `imptotal` int(11) NOT NULL DEFAULT '0',
  `impmade` int(11) NOT NULL DEFAULT '0',
  `clicks` int(11) NOT NULL DEFAULT '0',
  `clickurl` varchar(200) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `state` tinyint(4) NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
  `description` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `custombannercode` varchar(2048) COLLATE [[utf8]]_unicode_ci NOT NULL,
  `sticky` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `metakey` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `params` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `own_prefix` tinyint(4) NOT NULL DEFAULT '0',
  `metakey_prefix` varchar(400) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  ...
  `language` char(7) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `created_by` int(10) unsigned NOT NULL DEFAULT '0',
  `created_by_alias` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `[[dbprefix]]banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `contact` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `email` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `extrainfo` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `state` tinyint(4) NOT NULL DEFAULT '0',
  `checked_out` int(10) unsigned NOT NULL DEFAULT '0',
  `checked_out_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `metakey` text COLLATE [[utf8]]_unicode_ci NOT NULL,
...
CREATE TABLE `[[dbprefix]]categories` (
  ...
  `path` varchar(400) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `extension` varchar(50) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET [[utf8]] COLLATE [[utf8]]_bin NOT NULL DEFAULT '',
  `note` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `description` mediumtext COLLATE [[utf8]]_unicode_ci,
  `published` tinyint(4) NOT NULL DEFAULT '0',
  `checked_out` int(10) unsigned NOT NULL DEFAULT '0',
  `checked_out_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `access` int(10) unsigned NOT NULL DEFAULT '0',
  `params` text COLLATE [[utf8]]_unicode_ci,
  `metadesc` varchar(1024) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '' COMMENT 'The meta description for the page.',
  `metakey` varchar(1024) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '' COMMENT 'The meta keywords for the page.',
  `metadata` varchar(2048) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '' COMMENT 'JSON encoded metadata properties.',
  ...
  KEY `idx_language` (`language`)
) ENGINE=InnoDB  DEFAULT CHARSET=[[utf8]] COLLATE=[[utf8]]_unicode_ci AUTO_INCREMENT=8 ;
...
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 552, '[[regtime]]', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 552, '[[regtime]]', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 552, '[[regtime]]', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 552, '[[regtime]]', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 552, '[[regtime]]', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 552, '[[regtime]]', 0, '0000-00-00 00:00:00', 0, '*', 1);
...
CREATE TABLE `[[dbprefix]]contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL,
  `alias` varchar(400) CHARACTER SET [[utf8]] COLLATE [[utf8]]_bin NOT NULL,
  `con_position` varchar(255) COLLATE [[utf8]]_unicode_ci DEFAULT NULL,
  `address` text COLLATE [[utf8]]_unicode_ci,
  `suburb` varchar(100) COLLATE [[utf8]]_unicode_ci DEFAULT NULL,
  `state` varchar(100) COLLATE [[utf8]]_unicode_ci DEFAULT NULL,
  `country` varchar(100) COLLATE [[utf8]]_unicode_ci DEFAULT NULL,
  `postcode` varchar(100) COLLATE [[utf8]]_unicode_ci DEFAULT NULL,
  `telephone` varchar(255) COLLATE [[utf8]]_unicode_ci DEFAULT NULL,
  `fax` varchar(255) COLLATE [[utf8]]_unicode_ci DEFAULT NULL,
  `misc` mediumtext COLLATE [[utf8]]_unicode_ci,
  `image` varchar(255) COLLATE [[utf8]]_unicode_ci DEFAULT NULL,
  `email_to` varchar(255) COLLATE [[utf8]]_unicode_ci DEFAULT NULL,
  ...
  `access` int(10) unsigned NOT NULL DEFAULT '0',
  `mobile` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `webpage` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `sortname1` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `sortname2` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `sortname3` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `language` varchar(7) COLLATE [[utf8]]_unicode_ci NOT NULL,
  `created` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `created_by` int(10) unsigned NOT NULL DEFAULT '0',
  `created_by_alias` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `modified` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `modified_by` int(10) unsigned NOT NULL DEFAULT '0',
  `metakey` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `metadesc` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `metadata` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `featured` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT 'Set if contact is featured.',
  `xreference` varchar(50) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '' COMMENT 'A reference to enable linkages to external data sets.',
  `publish_up` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `publish_down` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `version` int(10) unsigned NOT NULL DEFAULT '1',
  `hits` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `[[dbprefix]]content` (
  ...
  `title` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET [[utf8]] COLLATE [[utf8]]_bin NOT NULL DEFAULT '',
  `introtext` mediumtext COLLATE [[utf8]]_unicode_ci NOT NULL,
  `fulltext` mediumtext COLLATE [[utf8]]_unicode_ci NOT NULL,
  `state` tinyint(4) NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
  `created` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `created_by` int(10) unsigned NOT NULL DEFAULT '0',
  ...
  `publish_up` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `publish_down` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `images` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `urls` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `attribs` varchar(5120) COLLATE [[utf8]]_unicode_ci NOT NULL,
  `version` int(10) unsigned NOT NULL DEFAULT '1',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `metakey` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `metadesc` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  ...
  `language` char(7) COLLATE [[utf8]]_unicode_ci NOT NULL COMMENT 'The language code for the article.',
  `xreference` varchar(50) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '' COMMENT 'A reference to enable linkages to external data sets.',
  `note` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
  KEY `idx_access` (`access`),
...
CREATE TABLE `[[dbprefix]]contentitem_tag_map` (
  `type_alias` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
...
) ENGINE=InnoDB DEFAULT CHARSET=[[utf8]] COLLATE=[[utf8]]_unicode_ci COMMENT='Maps items from content tables to tags';
...
CREATE TABLE `[[dbprefix]]content_rating` (
  ...
  `lastip` varchar(50) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`content_id`)
) ENGINE=InnoDB DEFAULT CHARSET=[[utf8]] COLLATE=[[utf8]]_unicode_ci;
...
CREATE TABLE `[[dbprefix]]content_types` (
  ...
  `type_title` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `type_alias` varchar(400) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `table` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `rules` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `field_mappings` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `router` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `content_history_options` varchar(5120) COLLATE [[utf8]]_unicode_ci DEFAULT NULL COMMENT 'JSON string for com_contenthistory options',
  PRIMARY KEY (`type_id`),
  KEY `idx_alias` (`type_alias`(100))
) ENGINE=InnoDB  DEFAULT CHARSET=[[utf8]] COLLATE=[[utf8]]_unicode_ci AUTO_INCREMENT=10000 ;
...
CREATE TABLE `[[dbprefix]]core_log_searches` (
  `search_term` varchar(128) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `hits` int(10) unsigned NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=[[utf8]] COLLATE=[[utf8]]_unicode_ci;
...
CREATE TABLE `[[dbprefix]]extensions` (
  ...
  `name` varchar(100) COLLATE [[utf8]]_unicode_ci NOT NULL,
  `type` varchar(20) COLLATE [[utf8]]_unicode_ci NOT NULL,
  `element` varchar(100) COLLATE [[utf8]]_unicode_ci NOT NULL,
  `folder` varchar(100) COLLATE [[utf8]]_unicode_ci NOT NULL,
  `client_id` tinyint(4) NOT NULL,
  `enabled` tinyint(4) NOT NULL DEFAULT '0',
  `access` int(10) unsigned NOT NULL DEFAULT '1',
  `protected` tinyint(4) NOT NULL DEFAULT '0',
  `manifest_cache` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `params` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `custom_data` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `system_data` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `checked_out` int(10) unsigned NOT NULL DEFAULT '0',
  `checked_out_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
(11, 0, 'com_languages', 'component', 'com_languages', '', 1, 1, 1, 1, '{"name":"com_languages","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2006 Open Source Matters, Inc.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.0.0","description":"COM_LANGUAGES_XML_DESCRIPTION","group":""}', '{"administrator":"[[language]]","site":"[[language]]"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(103, 0, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"LIB_JOOMLA","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"(C) 2008 Open Source Matters, Inc.","authorEmail":"admin@joomla.org","authorUrl":"https:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{"name":"plg_system_updatenotification","type":"plugin","creationDate":"May 2015","author":"Joomla! Project","copyright":"(C) 2015 Open Source Matters, Inc.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION","group":"","filename":"updatenotification"}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
CREATE TABLE `[[dbprefix]]fields` (
  ...
  `context` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `group_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `name` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `label` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `default_value` text COLLATE [[utf8]]_unicode_ci,
  `type` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT 'text',
  `note` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `description` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `state` tinyint(4) NOT NULL DEFAULT '0',
  ...
  `ordering` int(11) NOT NULL DEFAULT '0',
  `params` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `fieldparams` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `language` char(7) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `created_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `created_user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `modified_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
--
-- Table structure for table `[[dbprefix]]fields_categories`
--

CREATE TABLE `[[dbprefix]]fields_categories` (
...
--
-- Table structure for table `[[dbprefix]]fields_values`
--

CREATE TABLE `[[dbprefix]]fields_values` (
  `field_id` int(10) unsigned NOT NULL,
  `item_id` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL COMMENT 'Allow references to items which have strings as ids, eg. none db systems.',
  `value` text COLLATE [[utf8]]_unicode_ci,
...
--
-- Table structure for table `[[dbprefix]]finder_filters`
--

CREATE TABLE `[[dbprefix]]finder_filters` (
...
--
-- Table structure for table `[[dbprefix]]finder_links`
--

CREATE TABLE `[[dbprefix]]finder_links` (
...
--
-- Table structure for table `[[dbprefix]]finder_links_terms0`
--

CREATE TABLE `[[dbprefix]]finder_links_terms0` (
...
--
-- Table structure for table `[[dbprefix]]finder_links_terms1`
--

CREATE TABLE `[[dbprefix]]finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `[[dbprefix]]finder_links_terms2`
--

CREATE TABLE `[[dbprefix]]finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `[[dbprefix]]finder_links_terms3`
--

CREATE TABLE `[[dbprefix]]finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `[[dbprefix]]finder_links_terms4`
--

CREATE TABLE `[[dbprefix]]finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `[[dbprefix]]finder_links_terms5`
--

CREATE TABLE `[[dbprefix]]finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `[[dbprefix]]finder_links_terms6`
--

CREATE TABLE `[[dbprefix]]finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `[[dbprefix]]finder_links_terms7`
--

CREATE TABLE `[[dbprefix]]finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `[[dbprefix]]finder_links_terms8`
--

CREATE TABLE `[[dbprefix]]finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `[[dbprefix]]finder_links_terms9`
--

CREATE TABLE `[[dbprefix]]finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `[[dbprefix]]finder_links_termsa`
--

CREATE TABLE `[[dbprefix]]finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `[[dbprefix]]finder_links_termsb`
--

CREATE TABLE `[[dbprefix]]finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `[[dbprefix]]finder_links_termsc`
--

CREATE TABLE `[[dbprefix]]finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `[[dbprefix]]finder_links_termsd`
--

CREATE TABLE `[[dbprefix]]finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `[[dbprefix]]finder_links_termse`
--

CREATE TABLE `[[dbprefix]]finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `[[dbprefix]]finder_links_termsf`
--

CREATE TABLE `[[dbprefix]]finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `[[dbprefix]]finder_taxonomy`
--

CREATE TABLE `[[dbprefix]]finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `[[dbprefix]]finder_taxonomy`
--

INSERT INTO `[[dbprefix]]finder_taxonomy` VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `[[dbprefix]]finder_taxonomy_map`
--

CREATE TABLE `[[dbprefix]]finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `[[dbprefix]]finder_terms`
--

CREATE TABLE `[[dbprefix]]finder_terms` (
...
--
-- Table structure for table `[[dbprefix]]finder_terms_common`
--

CREATE TABLE `[[dbprefix]]finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `[[dbprefix]]finder_terms_common`
--

INSERT INTO `[[dbprefix]]finder_terms_common` VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `[[dbprefix]]finder_tokens`
--

CREATE TABLE `[[dbprefix]]finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(3) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `[[dbprefix]]finder_tokens_aggregate`
--

CREATE TABLE `[[dbprefix]]finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `[[dbprefix]]finder_types`
--

CREATE TABLE `[[dbprefix]]finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `[[dbprefix]]languages` (
  ...
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lang_code` char(7) CHARACTER SET [[utf8]] COLLATE [[utf8]]_bin NOT NULL,
  `title` varchar(50) COLLATE [[utf8]]_unicode_ci NOT NULL,
  `title_native` varchar(50) COLLATE [[utf8]]_unicode_ci NOT NULL,
  `sef` varchar(50) COLLATE [[utf8]]_unicode_ci NOT NULL,
  `image` varchar(50) COLLATE [[utf8]]_unicode_ci NOT NULL,
  `description` varchar(512) COLLATE [[utf8]]_unicode_ci NOT NULL,
  `metakey` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `metadesc` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `sitename` varchar(1024) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
...
) ENGINE=InnoDB  DEFAULT CHARSET=[[utf8]] COLLATE=[[utf8]]_unicode_ci AUTO_INCREMENT=2 ;
...
CREATE TABLE `[[dbprefix]]menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `menutype` varchar(24) COLLATE [[utf8]]_unicode_ci NOT NULL COMMENT 'The type of menu this item belongs to. FK to #__menu_types.menutype',
  `title` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL COMMENT 'The display title of the menu item.',
  `alias` varchar(400) CHARACTER SET [[utf8]] COLLATE [[utf8]]_bin NOT NULL COMMENT 'The SEF alias of the menu item.',
  `note` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `path` varchar(1024) COLLATE [[utf8]]_unicode_ci NOT NULL COMMENT 'The computed path of the menu item based on the alias field.',
  `link` varchar(1024) COLLATE [[utf8]]_unicode_ci NOT NULL COMMENT 'The actually link the menu item refers to.',
  `type` varchar(16) COLLATE [[utf8]]_unicode_ci NOT NULL COMMENT 'The type of link: Component, URL, Alias, Separator',
  ...
  `img` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL COMMENT 'The image of the menu item.',
  `template_style_id` int(10) unsigned NOT NULL DEFAULT '0',
  `params` text COLLATE [[utf8]]_unicode_ci NOT NULL COMMENT 'JSON encoded data for the menu item.',
  `lft` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set lft.',
  `rgt` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set rgt.',
  ...
  KEY `idx_path` (`path`(100)),
  KEY `idx_language` (`language`)
) ENGINE=InnoDB  DEFAULT CHARSET=[[utf8]] COLLATE=[[utf8]]_unicode_ci AUTO_INCREMENT=102 ;
...
--
-- Table structure for table `[[dbprefix]]menu_types`
--

CREATE TABLE `[[dbprefix]]menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0',
  `menutype` varchar(24) COLLATE [[utf8]]_unicode_ci NOT NULL,
  `title` varchar(48) COLLATE [[utf8]]_unicode_ci NOT NULL,
  `description` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
...
--
-- Dumping data for table `[[dbprefix]]menu_types`
--

INSERT INTO `[[dbprefix]]menu_types` VALUES
...
CREATE TABLE `[[dbprefix]]messages` (
  ...
  `subject` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `message` text COLLATE [[utf8]]_unicode_ci NOT NULL,
...
--
-- Table structure for table `[[dbprefix]]messages_cfg`
--

CREATE TABLE `[[dbprefix]]messages_cfg` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `cfg_name` varchar(100) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `cfg_value` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `[[dbprefix]]modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  `title` varchar(100) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `note` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `content` text COLLATE [[utf8]]_unicode_ci,
  `ordering` int(11) NOT NULL DEFAULT '0',
  `position` varchar(50) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `checked_out` int(10) unsigned NOT NULL DEFAULT '0',
  `checked_out_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `publish_up` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `publish_down` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `published` tinyint(4) NOT NULL DEFAULT '0',
  `module` varchar(50) COLLATE [[utf8]]_unicode_ci DEFAULT NULL,
  `access` int(10) unsigned NOT NULL DEFAULT '0',
  `showtitle` tinyint(3) unsigned NOT NULL DEFAULT '1',
  `params` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `client_id` tinyint(4) NOT NULL DEFAULT '0',
  `language` char(7) COLLATE [[utf8]]_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `published` (`published`,`access`),
  KEY `newsfeeds` (`module`,`published`),
  KEY `idx_language` (`language`)
) ENGINE=InnoDB  DEFAULT CHARSET=[[utf8]] COLLATE=[[utf8]]_unicode_ci AUTO_INCREMENT=90 ;
...
--
-- Table structure for table `[[dbprefix]]modules_menu`
--

CREATE TABLE `[[dbprefix]]modules_menu` (
...
--
-- Dumping data for table `[[dbprefix]]modules_menu`
--

INSERT INTO `[[dbprefix]]modules_menu` VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
CREATE TABLE `[[dbprefix]]newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(100) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET [[utf8]] COLLATE [[utf8]]_bin NOT NULL DEFAULT '',
  `link` varchar(2048) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `published` tinyint(4) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `[[dbprefix]]overrider`
--

CREATE TABLE `[[dbprefix]]overrider` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `constant` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL,
  `string` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `file` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=[[utf8]] COLLATE=[[utf8]]_unicode_ci AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `[[dbprefix]]postinstall_messages`
--

CREATE TABLE `[[dbprefix]]postinstall_messages` (
  `postinstall_message_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `extension_id` bigint(20) NOT NULL DEFAULT '700' COMMENT 'FK to #__extensions',
  `title_key` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '' COMMENT 'Lang key for the title',
  `description_key` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '' COMMENT 'Lang key for description',
  `action_key` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `language_extension` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT 'com_postinstall' COMMENT 'Extension holding lang keys',
  `language_client_id` tinyint(4) NOT NULL DEFAULT '1',
  `type` varchar(10) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT 'link' COMMENT 'Message type - message, link, action',
  `action_file` varchar(255) COLLATE [[utf8]]_unicode_ci DEFAULT '' COMMENT 'RAD URI to the PHP file containing action method',
  `action` varchar(255) COLLATE [[utf8]]_unicode_ci DEFAULT '' COMMENT 'Action method name or URL',
  `condition_file` varchar(255) COLLATE [[utf8]]_unicode_ci DEFAULT NULL COMMENT 'RAD URI to file holding display condition method',
  `condition_method` varchar(255) COLLATE [[utf8]]_unicode_ci DEFAULT NULL COMMENT 'Display condition method, must return boolean',
  `version_introduced` varchar(50) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '3.2.0' COMMENT 'Version when this message was introduced',
  `enabled` tinyint(4) NOT NULL DEFAULT '1',
  PRIMARY KEY (`postinstall_message_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=[[utf8]] COLLATE=[[utf8]]_unicode_ci AUTO_INCREMENT=11 ;

--
-- Dumping data for table `[[dbprefix]]postinstall_messages`
--

INSERT INTO `[[dbprefix]]postinstall_messages` VALUES
...
--
-- Table structure for table `[[dbprefix]]privacy_consents`
--

CREATE TABLE `[[dbprefix]]privacy_consents` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `state` int(11) NOT NULL DEFAULT '1',
  `created` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `subject` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `body` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `remind` tinyint(4) NOT NULL DEFAULT '0',
  `token` varchar(100) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
  KEY `idx_user_id` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=[[utf8]] COLLATE=[[utf8]]_unicode_ci AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `[[dbprefix]]privacy_requests`
--

CREATE TABLE `[[dbprefix]]privacy_requests` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `email` varchar(100) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `requested_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `status` tinyint(4) NOT NULL DEFAULT '0',
  `request_type` varchar(25) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `confirm_token` varchar(100) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
...
--
-- Table structure for table `[[dbprefix]]redirect_links`
--

CREATE TABLE `[[dbprefix]]redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `old_url` varchar(2048) COLLATE [[utf8]]_unicode_ci NOT NULL,
  `new_url` varchar(2048) COLLATE [[utf8]]_unicode_ci DEFAULT NULL,
  `referer` varchar(2048) COLLATE [[utf8]]_unicode_ci NOT NULL,
  `comment` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `hits` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `[[dbprefix]]schemas`
--

CREATE TABLE `[[dbprefix]]schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE [[utf8]]_unicode_ci NOT NULL,
  PRIMARY KEY (`extension_id`,`version_id`)
) ENGINE=InnoDB DEFAULT CHARSET=[[utf8]] COLLATE=[[utf8]]_unicode_ci;

--
-- Dumping data for table `[[dbprefix]]schemas`
--

INSERT INTO `[[dbprefix]]schemas` VALUES
...
CREATE TABLE `[[dbprefix]]session` (
  ...
  `data` mediumtext COLLATE [[utf8]]_unicode_ci,
  `userid` int(11) DEFAULT '0',
  `username` varchar(150) COLLATE [[utf8]]_unicode_ci DEFAULT '',
...
CREATE TABLE `[[dbprefix]]tags` (
  ...
  `level` int(10) unsigned NOT NULL DEFAULT '0',
  `path` varchar(400) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL,
  `alias` varchar(400) CHARACTER SET [[utf8]] COLLATE [[utf8]]_bin NOT NULL DEFAULT '',
  `note` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `description` mediumtext COLLATE [[utf8]]_unicode_ci NOT NULL,
  `published` tinyint(4) NOT NULL DEFAULT '0',
  `checked_out` int(10) unsigned NOT NULL DEFAULT '0',
  `checked_out_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `access` int(10) unsigned NOT NULL DEFAULT '0',
  `params` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `metadesc` varchar(1024) COLLATE [[utf8]]_unicode_ci NOT NULL COMMENT 'The meta description for the page.',
  `metakey` varchar(1024) COLLATE [[utf8]]_unicode_ci NOT NULL COMMENT 'The meta keywords for the page.',
  `metadata` varchar(2048) COLLATE [[utf8]]_unicode_ci NOT NULL COMMENT 'JSON encoded metadata properties.',
  `created_user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `created_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `created_by_alias` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `modified_user_id` int(10) unsigned NOT NULL DEFAULT '0',
...
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 552, '[[regtime]]', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `[[dbprefix]]template_styles`
--

CREATE TABLE `[[dbprefix]]template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `template` varchar(50) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `client_id` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `home` char(7) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '0',
  `title` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `inheritable` tinyint(4) NOT NULL DEFAULT '0',
  `parent` varchar(50) COLLATE [[utf8]]_unicode_ci DEFAULT '',
  `params` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_template` (`template`),
  KEY `idx_client_id` (`client_id`),
  KEY `idx_client_id_home` (`client_id`,`home`)
) ENGINE=InnoDB  DEFAULT CHARSET=[[utf8]] COLLATE=[[utf8]]_unicode_ci AUTO_INCREMENT=9 ;

--
-- Dumping data for table `[[dbprefix]]template_styles`
--

INSERT INTO `[[dbprefix]]template_styles` VALUES
...
CREATE TABLE `[[dbprefix]]ucm_base` (
...
--
-- Table structure for table `[[dbprefix]]ucm_content`
--

CREATE TABLE `[[dbprefix]]ucm_content` (
  `core_content_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `core_type_alias` varchar(400) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '' COMMENT 'FK to the content types table',
  `core_title` varchar(400) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `core_alias` varchar(400) CHARACTER SET [[utf8]] COLLATE [[utf8]]_bin NOT NULL DEFAULT '',
  `core_body` mediumtext COLLATE [[utf8]]_unicode_ci,
  `core_state` tinyint(4) NOT NULL DEFAULT '0',
  `core_checked_out_time` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '0000-00-00 00:00:00',
  `core_checked_out_user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `core_access` int(10) unsigned NOT NULL DEFAULT '0',
  `core_params` text COLLATE [[utf8]]_unicode_ci,
  `core_featured` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `core_metadata` varchar(2048) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '' COMMENT 'JSON encoded metadata properties.',
  `core_created_user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `core_created_by_alias` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `core_created_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `core_modified_user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Most recent user that modified',
  `core_modified_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `core_language` char(7) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `core_publish_up` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `core_publish_down` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `core_content_item_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'ID from the individual type table',
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  `core_images` text COLLATE [[utf8]]_unicode_ci,
  `core_urls` text COLLATE [[utf8]]_unicode_ci,
  `core_hits` int(10) unsigned NOT NULL DEFAULT '0',
  `core_version` int(10) unsigned NOT NULL DEFAULT '1',
  `core_ordering` int(11) NOT NULL DEFAULT '0',
  `core_metakey` text COLLATE [[utf8]]_unicode_ci,
  `core_metadesc` text COLLATE [[utf8]]_unicode_ci,
  `core_catid` int(10) unsigned NOT NULL DEFAULT '0',
  `core_xreference` varchar(50) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '' COMMENT 'A reference to enable linkages to external data sets.',
...
) ENGINE=InnoDB DEFAULT CHARSET=[[utf8]] COLLATE=[[utf8]]_unicode_ci COMMENT='Contains core content data in name spaced fields' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Table structure for table `[[dbprefix]]ucm_history`
--

CREATE TABLE `[[dbprefix]]ucm_history` (
  `version_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `ucm_item_id` int(10) unsigned NOT NULL,
  `ucm_type_id` int(10) unsigned NOT NULL,
  `version_note` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '' COMMENT 'Optional version name',
  `save_date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `editor_user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `character_count` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Number of characters in this version.',
  `sha1_hash` varchar(50) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '' COMMENT 'SHA1 hash of the version_data column.',
  `version_data` mediumtext COLLATE [[utf8]]_unicode_ci NOT NULL COMMENT 'json-encoded string of version data',
...
CREATE TABLE `[[dbprefix]]updates` (
  ...
  `name` varchar(100) COLLATE [[utf8]]_unicode_ci DEFAULT '',
  `description` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `element` varchar(100) COLLATE [[utf8]]_unicode_ci DEFAULT '',
  `type` varchar(20) COLLATE [[utf8]]_unicode_ci DEFAULT '',
  `folder` varchar(20) COLLATE [[utf8]]_unicode_ci DEFAULT '',
  `client_id` tinyint(4) DEFAULT '0',
  `version` varchar(32) COLLATE [[utf8]]_unicode_ci DEFAULT '',
  `data` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `detailsurl` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `infourl` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `extra_query` varchar(1000) COLLATE [[utf8]]_unicode_ci DEFAULT '',
  PRIMARY KEY (`update_id`)
) ENGINE=InnoDB DEFAULT CHARSET=[[utf8]] COLLATE=[[utf8]]_unicode_ci COMMENT='Available Updates' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Table structure for table `[[dbprefix]]update_sites`
--

CREATE TABLE `[[dbprefix]]update_sites` (
  `update_site_id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) COLLATE [[utf8]]_unicode_ci DEFAULT '',
  `type` varchar(20) COLLATE [[utf8]]_unicode_ci DEFAULT '',
  `location` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `enabled` int(11) DEFAULT '0',
  `last_check_timestamp` bigint(20) DEFAULT '0',
  `extra_query` varchar(1000) COLLATE [[utf8]]_unicode_ci DEFAULT '',
  PRIMARY KEY (`update_site_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=[[utf8]] COLLATE=[[utf8]]_unicode_ci COMMENT='Update Sites' AUTO_INCREMENT=4 ;

--
-- Dumping data for table `[[dbprefix]]update_sites`
--

INSERT INTO `[[dbprefix]]update_sites` VALUES
...
--
-- Table structure for table `[[dbprefix]]update_sites_extensions`
--

CREATE TABLE `[[dbprefix]]update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`update_site_id`,`extension_id`)
) ENGINE=InnoDB DEFAULT CHARSET=[[utf8]] COLLATE=[[utf8]]_unicode_ci COMMENT='Links extensions to update sites';

--
-- Dumping data for table `[[dbprefix]]update_sites_extensions`
--

INSERT INTO `[[dbprefix]]update_sites_extensions` VALUES
(1, 700),
(2, 802),
(3, 28);
...
) ENGINE=InnoDB  DEFAULT CHARSET=[[utf8]] COLLATE=[[utf8]]_unicode_ci AUTO_INCREMENT=10 ;
...
CREATE TABLE `[[dbprefix]]users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(400) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `username` varchar(150) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `email` varchar(100) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `password` varchar(100) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `block` tinyint(4) NOT NULL DEFAULT '0',
  `sendEmail` tinyint(4) DEFAULT '0',
  `registerDate` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `lastvisitDate` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `activation` varchar(100) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `params` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `lastResetTime` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Date of last password reset',
  `resetCount` int(11) NOT NULL DEFAULT '0' COMMENT 'Count of password resets since lastResetTime',
  `otpKey` varchar(1000) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '' COMMENT 'Two factor authentication encrypted keys',
  `otep` varchar(1000) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '' COMMENT 'One time emergency passwords',
  ...
  KEY `idx_block` (`block`),
  KEY `email` (`email`)
) ENGINE=InnoDB  DEFAULT CHARSET=[[utf8]] COLLATE=[[utf8]]_unicode_ci AUTO_INCREMENT=553 ;
...
(552, '[[admin_realname]]', '[[admin_username]]', '[[admin_email]]', '[[admin_pass]]', 0, 1, '[[regtime]]', '0000-00-00 00:00:00', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `[[dbprefix]]user_keys`
--

CREATE TABLE `[[dbprefix]]user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` varchar(150) COLLATE [[utf8]]_unicode_ci NOT NULL,
  `token` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL,
  `series` varchar(191) COLLATE [[utf8]]_unicode_ci NOT NULL,
  `invalid` tinyint(4) NOT NULL,
  `time` varchar(200) COLLATE [[utf8]]_unicode_ci NOT NULL,
  `uastring` varchar(255) COLLATE [[utf8]]_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `[[dbprefix]]user_notes`
--

CREATE TABLE `[[dbprefix]]user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
  `subject` varchar(100) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `body` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `state` tinyint(4) NOT NULL DEFAULT '0',
  `checked_out` int(10) unsigned NOT NULL DEFAULT '0',
  `checked_out_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE `[[dbprefix]]user_profiles` (
  `user_id` int(11) NOT NULL,
  `profile_key` varchar(100) COLLATE [[utf8]]_unicode_ci NOT NULL,
  `profile_value` text COLLATE [[utf8]]_unicode_ci NOT NULL,
  `ordering` int(11) NOT NULL DEFAULT '0',
  UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`)
) ENGINE=InnoDB DEFAULT CHARSET=[[utf8]] COLLATE=[[utf8]]_unicode_ci COMMENT='Simple user profile storage table';

-- --------------------------------------------------------

--
-- Table structure for table `[[dbprefix]]user_usergroup_map`
--
...
--
-- Dumping data for table `[[dbprefix]]user_usergroup_map`
--

INSERT INTO `[[dbprefix]]user_usergroup_map` VALUES
(552, 8);

-- --------------------------------------------------------

--
-- Table structure for table `[[dbprefix]]utf8_conversion`
--

CREATE TABLE `[[dbprefix]]utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=[[utf8]] COLLATE=[[utf8]]_unicode_ci;

--
-- Dumping data for table `[[dbprefix]]utf8_conversion`
--

INSERT INTO `[[dbprefix]]utf8_conversion` VALUES
([[converted]]);

-- --------------------------------------------------------

--
-- Table structure for table `[[dbprefix]]viewlevels`
--

CREATE TABLE `[[dbprefix]]viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) COLLATE [[utf8]]_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE [[utf8]]_unicode_ci NOT NULL COMMENT 'JSON encoded access control.',
...
) ENGINE=InnoDB  DEFAULT CHARSET=[[utf8]] COLLATE=[[utf8]]_unicode_ci AUTO_INCREMENT=7 ;

--
-- Dumping data for table `[[dbprefix]]viewlevels`
--

INSERT INTO `[[dbprefix]]viewlevels` VALUES
(1, 'Public', 0, '[1]'),
