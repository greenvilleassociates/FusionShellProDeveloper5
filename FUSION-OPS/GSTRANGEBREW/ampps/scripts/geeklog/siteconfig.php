...
// Please note: If you change $_CONF['default_charset'], you need to make sure your site is using a compativle langague and that the database is using a compatible character set as well (also see dbconfig.php and $_DB_charset setting).
