...
// Application name
const NOMAPPLICATION = '[[site_name]]';
...
const DB_CONNECTION_STRING = 'mysql:host=[[softdbhost]];dbname=[[softdb]];port=3306';
...
$config = [
    ...
    'smtp_options' => [
        'host' => '[[smtp]]',              // SMTP server (you could add many servers (main and backup for example) : use ";" like separator
        'auth' => [[auth_enable]],                    // Enable SMTP authentication
        'username' => '[[smtp_username]]',                   // SMTP username
        'password' => '[[smtp_password]]',                   // SMTP password
        'secure' => '[[smtp_conn_prefix]]',                     // Enable encryption (false, tls or ssl)
